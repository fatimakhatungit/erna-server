...
cron.schedule("0 * * * *", async () => {
  ...
  for (const cart of abandonedCarts) {
    if (cart.email) {
      const mailOptions = {
        from: '"erna E-Commerce" <no-reply@erna.com>',
        to: cart.email,
        subject: "আপনার কার্টে কিছু প্রোডাক্ট বাকি রয়ে গেছে! 🛒",
        html: `
          <div style="font-family: Arial, sans-serif; padding: 20px;">
            <h2>প্রিয় ${cart.name || "গ্রাহক"},</h2>
            <p>আপনি erna-এ চেকআউট সম্পন্ন করতে ভুলে গেছেন। আপনার পছন্দের আইটেমগুলো এখনও কার্টে অপেক্ষা করছে!</p>
            <p><strong>মোট মূল্য: ৳${cart.totalAmount}</strong></p>
            <a href="https://erna.com/checkout" style="background: #ff594d; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">অর্ডার সম্পন্ন করুন</a>
          </div>
        `,
      };
