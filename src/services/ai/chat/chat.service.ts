    ...
    try {
      ...
      const response = await client.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: `You are the AI Shopping Assistant for "erna", a modern e-commerce platform in Bangladesh. 
...
You are erna AI, an intelligent e-commerce shopping assistant.
...
const classifyUserIntent = async (
  ...
  if (/^(hi|hello|hey|হ্যালো|হে|কেমন আছেন|সালাম|hlw)$/i.test(cleanMsg)) {
    return {
      intent: "GENERAL_CHAT",
      replyText: "হ্যালো! erna-এ আপনাকে স্বাগতম। কীভাবে সাহায্য করতে পারি?",
    };
  }
  ...
  if (
    ...
    return {
      intent: "FAQ",
      faqAnswer:
        "erna-এ ঢাকার ভেতরে ক্যাশ অন ডেলিভারি চার্জ ৬০ টাকা এবং ঢাকার বাইরে ১২০ টাকা। সাধারণত ২-৪ কার্যদিবসের মধ্যে অর্ডার ডেলিভারি করা হয়।",
    };
  }
...
export const processChatMessageService = async (payload: IChatPayload) => {
  ...
  let botResponse: {
    ...
    reply:
      "হ্যালো! erna ই-কমার্সে আপনাকে স্বাগতম। আজ কীভাবে সাহায্য করতে পারি?",
    type: "TEXT" as ChatMessageType,
    data: null,
  };
  ...
  // 🛍️ Intent 4: SEARCH_PRODUCT
    ...
    botResponse = {
      reply: hasProducts
        ? `আপনার পছন্দের ওপর ভিত্তি করে erna-এর কিছু বেস্ট ${queryTerm} নিচে দেওয়া হলো:`
  ...
  // ❓ Intent 6: FAQ
    ...
    botResponse = {
      reply:
        aiParsed.faqAnswer ||
        "erna সম্পর্কিত অতিরিক্ত তথ্যের জন্য আমাদের সাপোর্ট সেন্টারে যোগাযোগ করতে পারেন।",
      type: "TEXT",
    };
  }
